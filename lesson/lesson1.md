...
- Реализуйте класс `com.urise.webapp.MainArray.com.urise.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.urise.webapp.MainArray.main()` и `com.urise.webapp.MainTestArrayStorage.main()`
...
1. Не меняйте сигнатуры методов в `com.urise.webapp.MainArray.com.urise.webapp.storage.ArrayStorage`
