...
- Реализуйте класс `MainArray.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
1. Не меняйте сигнатуры методов в `MainArray.ArrayStorage`
