...
//----------------------------------------------------------
        Section section = new TextSection("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям");
        resume.setSections(SectionType.OBJECTIVE, section);
        section = new TextSection("Аналитический склад ума, сильная логика, креативность, инициативность.\n" +
...
//----------------------------------------------------------
        prepareOrganizationList(new String[]{"2013-10-01"}, new String[]{"0"}, new String[]{"Автор проекта"}, "Создание, организация и проведение Java онлайн проектов и стажировок", "Java Online Projects");
        prepareOrganizationList(new String[]{"2014-10-01"}, new String[]{"2016-01-01"}, new String[]{"Старший разработчик (backend)"}, "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.", "Wrike");
        prepareOrganizationList(new String[]{"2012-04-01"}, new String[]{"2014-10-01"}, new String[]{"Java архитектор"}, "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.", "RIT Center");
        prepareOrganizationList(new String[]{"2010-12-01"}, new String[]{"2012-04-01"}, new String[]{"Ведущий программист"}, "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM.\n" +
        ...
        prepareOrganizationList(new String[]{"2008-06-01"}, new String[]{"2010-12-01"}, new String[]{"Ведущий специалист"}, "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)", "Yota");
        prepareOrganizationList(new String[]{"2007-03-01"}, new String[]{"2008-06-01"}, new String[]{"Разработчик ПО"}, "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).", "Enkata");
        prepareOrganizationList(new String[]{"2005-01-01", "2005-01-01"}, new String[]{"2007-02-01", "2007-02-01"}, new String[]{"Разработчик ПО", "Разработчик ПО"},"Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix)." , "Siemens AG");
        prepareOrganizationList(new String[]{"1997-09-01"}, new String[]{"2005-01-01"}, new String[]{"Инженер по аппаратному и программному тестированию"}, "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).","Alcatel");
        section = new OrganizationSection(organizationList);
        resume.setSections(SectionType.EXPIRIENCE, section);
//----------------------------------------------------------
        organizationList = new ArrayList<>();
        prepareOrganizationList(new String[]{"1993-09-01", "1987-09-01"}, new String[]{"1997-09-01", "1993-09-01"}, new String[]{"Аспирантура (программист С, С++)", "Инженер (программист Fortran, C)"}, "","Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики");
        section = new OrganizationSection(organizationList);
        resume.setSections(SectionType.EDUCATION, section);

        for (SectionType sectionType : SectionType.values()) {
            Section section1 = resume.getSection(sectionType);
            try {
    ...
    private static void prepareOrganizationList(String[] startDate, String[] endDate, String[] jobName, String description, String organ) {
        ...
        for (int i = 0; i < jobName.length; i++) {
            LocalDate start = LocalDate.parse(startDate[i]);
            LocalDate end = LocalDate.ofEpochDay(0);
            if (!endDate[i].equals("0")) {
                end = LocalDate.parse(endDate[i]);
            }
